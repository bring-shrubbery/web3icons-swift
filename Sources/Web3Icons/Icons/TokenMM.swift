...
internal struct TokenMM: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        var _hole4 = Path()
        _hole4.move(to: CGPoint(x: 0.7205833333*width, y: 0.3235833333*height))
        _hole4.addLine(to: CGPoint(x: 0.7205833333*width, y: 0.6765*height))
        _hole4.addLine(to: CGPoint(x: 0.6985*width, y: 0.6765*height))
        _hole4.addLine(to: CGPoint(x: 0.6985*width, y: 0.38975*height))
        _hole4.addLine(to: CGPoint(x: 0.6102916667*width, y: 0.4979166667*height))
        _hole4.addLine(to: CGPoint(x: 0.6102916667*width, y: 0.6765*height))
        _hole4.addLine(to: CGPoint(x: 0.432375*width, y: 0.6765*height))
        _hole4.addLine(to: CGPoint(x: 0.5882083333*width, y: 0.4857916667*height))
        _hole4.addLine(to: CGPoint(x: 0.5882083333*width, y: 0.393125*height))
        _hole4.addLine(to: CGPoint(x: 0.449375*width, y: 0.565*height))
        _hole4.addLine(to: CGPoint(x: 0.3014583333*width, y: 0.393125*height))
        _hole4.addLine(to: CGPoint(x: 0.3014583333*width, y: 0.6765*height))
        _hole4.addLine(to: CGPoint(x: 0.279375*width, y: 0.6765*height))
        _hole4.addLine(to: CGPoint(x: 0.279375*width, y: 0.3235833333*height))
        _hole4.addLine(to: CGPoint(x: 0.4494583333*width, y: 0.52375*height))
        _hole4.addLine(to: CGPoint(x: 0.6102916667*width, y: 0.3235833333*height))
        _hole4.addLine(to: CGPoint(x: 0.6102916667*width, y: 0.459375*height))
        _hole4.closeSubpath()
        _hole4.move(to: CGPoint(x: 0.5882083333*width, y: 0.6544166667*height))
        _hole4.addLine(to: CGPoint(x: 0.481875*width, y: 0.6544166667*height))
        _hole4.addLine(to: CGPoint(x: 0.5882083333*width, y: 0.5248333333*height))
        _hole4.closeSubpath()
